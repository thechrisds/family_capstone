...
DROP TABLE IF EXISTS users, library, reading_activity, prizes CASCADE;

DROP SEQUENCE IF EXISTS seq_user_id, seq_library_id, activity_id, prizes_id;
...
CREATE TABLE reading_activity (
    ...
    CONSTRAINT FK_family_id FOREIGN KEY (family_id) REFERENCES users (family_id),
